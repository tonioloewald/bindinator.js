...
export const configuration = [
  ...
  },
  {
    ...
    values: [
      ...
      {
        description: 'b8r logo greyscale',
        value: 'images/bindinator-logo.svg',
      },
    ],
  },
  {
...
export const examples = [
  ...
  },
  {
    skipSnapshot: true,
    name: 'no logo',
    settings: [{ name: 'logoUrl', option: 0 }],
  },
  {
    name: 'Sydney Time',
    skipSnapshot: true,
    settings: [{ name: 'getHMS', option: 2 }],
  },
  {
    name: 'GMT',
    skipSnapshot: true,
  ...
  {
    name: 'fixed time (5PM)',
    settings: [{ name: 'getHMS', option: 3 }],
  },
  {
    name: 'fixed time (5 seconds to midnight)',
    settings: [{ name: 'getHMS', option: 4 }],
  },
]
  ...
  load: async ({ get, set, findOne }) => {
    ...
    const update = () => {
      ...
      if (timeText !== get('time')) {
        ...
        const hourHand =
          (parseInt(hours, 10) % 12) * 30 + parseInt(minutes, 10) * 0.5
        const minuteHand =
          parseInt(minutes, 10) * 6 + parseInt(seconds, 10) * 0.1
