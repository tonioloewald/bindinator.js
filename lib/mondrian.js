  ...
  module.exports = {
    arrange(elements, aspect_ratio) {
      ...
      while(row_count * col_count < item_count) {
        ...
        var distortion_with_new_row = distance_from_1((row_count + 1) / col_count * aspect_ratio);
        var distortion_with_new_col = distance_from_1(row_count / (col_count + 1) * aspect_ratio);

        console.log({aspect_ratio, distortion_with_new_row, distortion_with_new_col});
