...
**aspect_ratio** is the desired width / height of the child elements. By default this is 1.
...
(function(module) {
  ...
  module.exports = {
    arrange(elements, aspect_ratio) {
      ...
      const container_aspect_ratio = elements[0].parentElement.offsetWidth / elements[0].parentElement.offsetHeight;
      ...
      while(row_count * col_count < item_count) {
        ...
        var distortion_with_new_row = distance_from_1((row_count + 1) / col_count / target_aspect_ratio);
        var distortion_with_new_col = distance_from_1(row_count / (col_count + 1) / target_aspect_ratio);
