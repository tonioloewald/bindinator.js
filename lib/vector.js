...
<script>
  ...
  const concave = [[121,1],[137,26],[122,64],[182,65],[182,126],[150,126],[150,87],[133,87],[133,154],[179,154],[179,201],[156,201],[156,179],[102,179],[101,145],[59,145],[59,184],[1,184],[1,161],[26,160],[27,123],[68,122],[68,100],[10,101],[10,39],[42,39],[42,77],[68,77],[68,65],[82,64],[68,47],[84,1]]
    .map(v => add(v, [-100,-100]))
  set('rotation', 35)
  set('scale', 1)
  set('count', 10000)
  ...
  set('render', async (element, [rotation, scale, count, sides]) => {
    ...
    for(let i = 0; i < count; i++) {
      ...
      g.fillStyle = isInPoly([x,y], poly) ? '#f00' : '#444'
      g.fillRect(x, y, 1, 1)
    }
