...
The `undoManager` instance has `undo` and `redo` methods, `canUndo` and `canRedo` properties
...
PATH is the (first) path the undoManager was told to watch. (In the preceding example, that would 
