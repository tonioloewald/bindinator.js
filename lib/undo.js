...
<button
  ...
  data-bind="disabled_if(1)=_simple-undo-example_history.undoBuffer.length"
>undo</button>
<button
...
<button
  ...
  data-bind="disabled_if(1)=_undo-example_history.undoBuffer.length"
>undo</button>
<button
...
Test(() => undoManager.redoBuffer.length, 'redoBuffer reset').shouldBe(0)
b8r.remove(path)
undoManager.destroy()
~~~~
*/
