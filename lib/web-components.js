...
- `value` can be truthy or {writeable: true} if you want a value that changes.
...
- `ariaRole` will do the expected thing
    ...
    makeElement(tagType, {content=false, attributes={}, styles={}, classes=[]})
...
const makeElement = (tagType, {content=false, attributes={}, styles={}, classes=[]}) => {
...
const _setNotAllowed = function(){ 
  console.error(this, 'value is read only'); 
};
