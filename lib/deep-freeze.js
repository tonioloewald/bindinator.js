...
deepFreeze is the a non-shallow implementation of `Object.freeze` that
...
~~~~
const deepFreeze = require('lib/deep-freeze.js');
...
const freezeProperty = (obj, prop) => {
  ...
  Object.defineProperty(obj, prop, {
    ...
    set(value){
      throw `failed to set ${prop} on frozen object ${obj}`;
    },
  });
};

const deepFreeze = (obj, throwErrorsOnSet=false) => {
