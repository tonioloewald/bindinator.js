...
(function(global) {
  ...
  Object.assign(require_utils, {
    ...
    viaTag: _viaTag,
    electron: global.process && _global_require('electron'),
    globalRequire: _global_require,
    modules: () => modules,
  });

  // TODO -- remove this
  Object.defineProperty(require_utils, 'electron_remote', {
    get: function() {
      console.warn('require.electron_remote is deprecated, please use require.electron.remote');
      return (this.electron_remote = global.process && _global_require('electron').remote);
    }
  });
