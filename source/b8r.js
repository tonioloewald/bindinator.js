...
const dom = require('source/b8r.dom');
...
const toTargets = require('source/b8r.toTargets');
const fromTargets = require('source/b8r.fromTargets');
...
const ajax = require('source/b8r.ajax');
